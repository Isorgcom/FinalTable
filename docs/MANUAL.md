...
the cards are out, who can watch, whether busting is the end, and how much of
what the server is doing you can see without opening a tab. The short
version, with where to read more:

| Version | What arrived                                                                                                                                                                                                                                                                                                | See                                                                                                                                                   |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.11.0  | Forfeit: a way out of a game for good, from the table menu or the lobby card. Whoever made a game can end it while it runs, even after busting out of it. The felt says what it is doing: a seat that goes without a hand, the add-on landing, and the add-on asked on the felt once the break has settled. | [Leaving and coming back](#leaving-and-coming-back), [The host at the table](#the-host-at-the-table), [How a tournament runs](#how-a-tournament-runs) |
