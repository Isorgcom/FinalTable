...
- **Docs**: `README.md` (what it does and how to run it), `CHANGELOG.md` (what changed), `ROADMAP.md` (where it is going), `docs/DEPLOYMENT.md` (how it reaches a server), `docs/API.md` (what GameNight calls), `FORK.md` (lineage and licence), `CLAUDE.md` (the working rules)
